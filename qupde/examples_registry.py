...
EXAMPLE_SPECS: tuple[ExampleSpec, ...] = (
    ExampleSpec(
        id="kdv",
        name="Modified Korteweg-de Vries equation",
        filename="KDV.py",
        func_eq=[("u", "u_t")],
        diff_ord=3,
    ),
    ...
    ExampleSpec(
        id="fitz-hugh-nagumo",
        name="FitzHugh-Nagumo system",
        filename="fitz-hugh-nagumo.py",
        func_eq=[("v", "v_t"), ("y", "y_t")],
        diff_ord=2,
    ),
    ExampleSpec(
        id="gray_scott_equations",
        name="Gray-Scott equations",
    ...
    ExampleSpec(
        ...
        name="Tubular reactor (Arrhenius) model",
